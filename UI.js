...
let _pitch = 1;
let _interval = false;
let interval_staff = false;

//const keyboard_note = document.querySelectorAll("keyboard-note");


const keyboard_note = document.querySelectorAll(".key");




for (i = 0; i < keyboard_note.length-24; i++) {

    const key_cues02 = document.createElement("div");
    
    key_cues02.textContent = updown02[i];

   

    key_cues02.style.position = "absolute";

   
    key_cues02.style.top = '-40px';

    if (i % 12 === 0 || i % 12 === 2 || i % 12 === 4 || i % 12 === 5 || i % 12 === 7 || i % 12 === 9 || i % 12 === 11) {
       
        key_cues02.style.top = '-30px';

       
        key_cues02.style.color = "white";

    } else {
      
        key_cues02.style.color = "black";
        key_cues02.style.fontWeight = "600";
    }

   

    keyboard_note[i + 12].appendChild(key_cues02);




    const key_cues01 = document.createElement("div");
   
    key_cues01.textContent = updown01[i];

 key_cues01.style.position = "absolute";

  key_cues01.style.top = '-60px';
  

    if (i == 0 || i == 2 || i == 4 || i == 6 || i == 7 || i == 9 || i == 11 || i == 12 || i == 14 || i == 16 || i == 18 || i == 19) {
      key_cues01.style.top = '-50px';
  
      key_cues01.style.color = "white";
       

    } else {
        key_cues01.style.color = "black";
        key_cues01.style.fontWeight = "600";
       
    }

    

    keyboard_note[i + 17].appendChild(key_cues01);
...
const change_mode = document.querySelectorAll(".changemode");
    ...
    mode_switch[0].addEventListener('click', function () {
        ...
        document.getElementById("staff-writer").style.visibility = "visible";
        interval_staff = false;

        write_or_not(document.getElementById("staff-writer"));
    ...
    mode_switch[1].addEventListener('click', function () {
        ...
        edit_notes = false;
        document.getElementById("clear").style.visibility = "collapse";
        ...
        document.getElementById("staff-writer").style.visibility = "collapse";
        interval_staff = false;
